...
public class JdbcRowSetTest {
    ...
    private static final String DATABASE_URL = "jdbc:myql://s-l112-engr.uiowa.edu:3306/engr_class009";
    ...
    public static void main(String args[]) {
        ...
        try (JdbcRowSet rowSet =
            ...
            rowSet.setCommand("SELECT * FROM login WHERE username = '" + user + "' and password = '" + password + "'"); // set query
